...
namespace GeNa
{
    public static class GeNaEditorUtility
    {
        ...
        public static void RenderSpawnRange(GeNaSpawnerData spawner, Vector3 position)
        {
        ...
        /// <summary>
        /// Adds a GeNa.Core.Spawner
        /// </summary>
        [MenuItem("GameObject/GeNa/Add GeNa.Core.Spawner", false, 14)]
        public static void AddSpawner()
        {
            //Create the spawner
            GameObject genaGo = new GameObject("GeNa.Core.Spawner");
            GeNa.Core.Spawner spawner = genaGo.AddComponent<GeNa.Core.Spawner>();
        ...
        public static GeNaSpawnerData ApplyToMain(GeNaSpawner spawner)
        {
            ...
            foreach (Object @object in objects)
            {
                ...
                if (mainFile.name.Contains("Main"))
                {
                    AssetDatabase.RemoveObjectFromAsset(mainFile);
                }
            }
            mainFile = spawner.SpawnerData;
            mainFile.name = "GeNa.Core.Spawner Data (Main)";
            AssetDatabase.AddObjectToAsset(mainFile, asset);
            AssetDatabase.Refresh();
        ...
        public static DataBufferScriptable GetMainDataBufferScriptable(GeNaSpawner spawner)
        {
            ...
            if (dataFile == null)
            {
                ...
                dataFile.name = "GeNa.Core.Spawner Data (Main)";
        ...
        public static GeNaSpawnerData GetMainSpawnerData(GeNaSpawner spawner)
        {
            ...
            if (spawnerData == null)
            {
                ...
                spawnerData.name = "GeNa.Core.Spawner Data (Main)";
