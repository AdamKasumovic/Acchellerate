...
public class RCC_WheelCollider : RCC_Core {
    ...
    private void SkidMarks() {
        ...
        if (!RCC_Settings.Instance.dontUseSkidmarks && !(CarManager.currentState == CarManager.CarState.TiltingLeft || CarManager.currentState == CarManager.CarState.TiltingRight)) {
