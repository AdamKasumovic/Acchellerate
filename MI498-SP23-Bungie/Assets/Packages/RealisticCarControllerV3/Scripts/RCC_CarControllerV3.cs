...
public class RCC_CarControllerV3 : RCC_Core {
    ...
    #region Fuel
    // Fuel.
    public bool useFuelConsumption = true;     // Enable / Disable Fuel Consumption.
    ...
    private void OnCollisionEnter(Collision collision) {
        ...
        if (((1 << collision.gameObject.layer) & damage.damageFilter) != 0) {
            ...
            StartCoroutine(GameManager.instance.DoVibration((CarManager.carSpeed + 40f)/CarManager.carMaxSpeed, (CarManager.carSpeed + 40f) / CarManager.carMaxSpeed, 0.25f));

            if (useCollisionAudio && !CarManager.Instance.groundPoundKillIndicator) {
